...
arbitrageRouter.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      const totalProfitAgg = await prismaRead.arbitrageBot.aggregate({
...
arbitrageRouter.get(
  '/visualizations/opportunity-heatmap',
  asyncHandler(async (_req: Request, res: Response) => {
    try {
      const since7d = new Date(Date.now() - 7 * 86400000);
...
arbitrageRouter.get(
  '/visualizations/profit-timeline',
  asyncHandler(async (req: Request, res: Response) => {
    try {
...
arbitrageRouter.get(
  '/visualizations/sandwich-timeline',
  asyncHandler(async (req: Request, res: Response) => {
    try {
      const hours = parseInt(req.query.hours as string) || 24;
      const since = new Date(Date.now() - hours * 3600000);
...
arbitrageRouter.get(
  '/visualizations/market-efficiency',
  asyncHandler(async (_req: Request, res: Response) => {
    try {
      const since24h = new Date(Date.now() - 86400000);
