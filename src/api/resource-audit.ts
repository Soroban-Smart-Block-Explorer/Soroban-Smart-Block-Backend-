 ...
 */
resourceAuditRouter.get('/contracts/:contractId', asyncHandler(async (req: Request, res: Response) => {
 ...
 */
resourceAuditRouter.get('/contracts/:contractId/history', asyncHandler(async (req: Request, res: Response) => {
  const { contractId } = req.params;
 ...
 */
resourceAuditRouter.get('/network/summary', asyncHandler(async (_req: Request, res: Response) => {
 ...
 */
resourceAuditRouter.get('/top-consumers', asyncHandler(async (req: Request, res: Response) => {
 ...
 */
resourceAuditRouter.post('/simulate', asyncHandler(async (req: Request, res: Response) => {
